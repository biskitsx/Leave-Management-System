        ...
        <div className='p-2 flex flex-col gap-10 items-center'>
            ...
            <div className='flex flex-col gap-10 w-8/12'>
                <div className='flex flex-col gap-4'>
                    <h1 className='text-4xl font-bold text-center'>ยินดีต้อนรับ <span className='text-blue-700'>{user?.first_name}</span> 👋🏻</h1>
                    <h1 className='text-xl font-normal text-center'>สรุปยอดการลาทั้งหมด</h1>
                </div>
                <LeaveCount />
                <AddLeaveBtn />
                <LeaveTable />
